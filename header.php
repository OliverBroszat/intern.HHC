...
<head>
	...
	<script src='<?php echo $root_uri; ?>/import/JQuery/1.12.0.jquery.min.js'></script>
	<script src='<?php echo $root_uri; ?>/import/JQuery/1.11.4.jquery-ui.min.js'></script>
	<link rel='stylesheet' href='<?php echo $root_uri; ?>/import/JQuery/1.11.4.jquery-ui.min.css'>
