function popup(content, name, title){
	...
	if (id == 1) { $('#popup-'+id+' .popup-blende').fadeIn(300); }
	else{ $('#popup-'+id+' .popup-blende').show(); }
...
function image_popup(href, event){
	...
	popup("<img src='"+href+"' onclick='popup_close();'><div class='close' onclick='popup_close()'>&#215;</div>", 'image');
